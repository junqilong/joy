            ...
            <div class="chat_post">
                ...
                <div class="cbox-post">
                    ...
                    <div class="cbox-ats clearfix">
                        <div class="ats-func">
                           <#-- -->
                            <#--<div class="OwO" id="btn_owo"></div>-->
                            <button id="btn_owo" class="btn btn-default btn-block">emoji</button>
                        </div>
                        <div class="ats-issue">
...
<script type="text/javascript">
    ...
    $.Lemoji({
        emojiInput: '#chat_text',
        emojiBtn: '#btn_owo',
        position: 'RIGHTBOTTOM',
        length: 8,
        emojis: {
            qq: {path: '${base}/dist/images/qq/', code: ':', name: 'QQ表情'},
            tieba: {path: '${base}/dist/images/tieba', code: ';', name: "贴吧表情"},
            emoji: {path: '${base}/dist/images/emoji', code: ',', name: 'Emoji表情'}
        }
    });
</script>
</@layout>
